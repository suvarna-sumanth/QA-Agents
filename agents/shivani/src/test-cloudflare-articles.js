/**
 * Cloudflare Article Test Script
 * 
 * Standalone script to:
 * 1. Accept domain from user
 * 2. Use LLM to extract latest article URLs
 * 3. Test player on each article using Playwright with Cloudflare bypass
 * 4. Generate screenshots for each test
 * 
 * Usage: node test-cloudflare-articles.js <domain>
 * Example: node test-cloudflare-articles.js https://www.thebrakereport.com
 */
...
const CURL_BIN_DIR = path.resolve(__dirname, '../../../bin');
